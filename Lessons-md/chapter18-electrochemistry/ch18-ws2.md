...
> 
> $E^\circ$ (V): F₂/F- $+2.87$ • Cl₂/Cl- $+1.36$
> • Ag+/Ag $+0.80$ • Fe³⁺/Fe²⁺ $+0.77$
> • I₂/I- $+0.54$ • Cu²⁺/Cu $+0.34$
> • H+/H₂ $0.00$ • Pb²⁺/Pb $-0.13$
> • Ni²⁺/Ni $-0.23$ • Fe²⁺/Fe $-0.44$
> • Zn²⁺/Zn $-0.76$ • Al³⁺/Al $-1.66$
> • Mg²⁺/Mg $-2.37$.
...
**4.** In problem 3(c), the aluminium half-reaction was doubled and the
...
1. For the Daniell cell ($E^\circ = +1.10$ V, $n = 2$), calculate
   $\Delta G^\circ$ in kJ.
   *(working space)*
2. For Cu + 2Ag+ → Cu²⁺ + 2Ag, calculate $E^\circ$ and then
   $\Delta G^\circ$.
   *(working space)*
...
For the Daniell cell, calculate $\ln K$ and $K$ at
        298 K. 
...
Explain why a cell voltage of only 1.10 V corresponds to an
