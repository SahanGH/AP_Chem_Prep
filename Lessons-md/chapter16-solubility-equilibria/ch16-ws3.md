...
> 📌 **Directions & data**
>
> $K_{sp}$: AgCl $1.6\times10^{-10}$ • AgBr
> $5.0\times10^{-13}$ • BaSO₄ $1.5\times10^{-9}$
> • PbI₂ $1.4\times10^{-8}$ • PbCl₂
> $1.6\times10^{-5}$ • CaF₂ $4.0\times10^{-11}$
> • MgF₂ $6.4\times10^{-9}$ • Ag₂CrO₄
> $9.0\times10^{-12}$.
...
**5.** Now a salt with a squared ion. Calculate the solubility of
PbI₂:
...
**8.** A student writes: “Adding NaCl lowers $K_{sp}$ for
