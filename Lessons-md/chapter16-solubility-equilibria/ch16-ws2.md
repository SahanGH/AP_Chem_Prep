...
> 📌 **Directions & data**
>
> $K_{sp}$ at 25 °C: AgCl $1.6\times10^{-10}$
> • AgI $1.5\times10^{-16}$ • CuI
> $5.0\times10^{-12}$ • BaSO₄ $1.5\times10^{-9}$
> • CaSO₄ $6.1\times10^{-5}$ • PbSO₄
> $1.3\times10^{-8}$ • SrSO₄ $3.2\times10^{-7}$
> • CaF₂ $4.0\times10^{-11}$ • MgF₂
> $6.4\times10^{-9}$ • BaCrO₄ $8.5\times10^{-11}$
> • Mg(OH)₂ $8.9\times10^{-12}$ • Ag₃PO₄
> $1.8\times10^{-18}$.
...
|---|---|---|---|
| CuS | MX | $8.5\times10^{-45}$ |  |
| Ag₂S | M₂X | $1.6\times10^{-49}$ |  |
| Bi₂S₃ | M₂X₃ | $1.1\times10^{-73}$ |  |
