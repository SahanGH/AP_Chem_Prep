...
![figure](fig-ch09-selfstudy-2.png)
...
> 📌 **AP scope: the $d$-orbital labels are not assessed**
>
> The CED's topic 2.7 exclusion is explicit: *“Hybridization
> involving $d$ orbitals will not be assessed on the AP Exam. When an atom
> has more than four pairs of electrons surrounding the central atom,
> students are only responsible for the shape of the resulting
> molecule.”* So $sp$, $sp^{2}$ and $sp^{3}$ are assessed vocabulary,
> while $sp^{3}d$ and $sp^{3}d^{2}$ are Zumdahl's completion of the
> pattern, kept so the table matches the textbook. For 5 and 6 domains,
> know the *shapes* — trigonal bipyramidal and octahedral — and
> do not expect to be asked to name their hybridization.
...
![figure](fig-ch09-selfstudy-3.png)

![figure](fig-ch09-selfstudy-4.png)
...
![figure](fig-ch09-selfstudy-5.png)
...
![figure](fig-ch09-selfstudy-6.png)
...
![figure](fig-ch09-selfstudy-7.png)
...
![figure](fig-ch09-selfstudy-10.png)
