...
> 📌 **Directions & data**
>
> Zumdahl Appendix 4. Columns: $\Delta H_f^\circ$ (kJ/mol),
> $\Delta G_f^\circ$ (kJ/mol), $S^\circ$ (J/K$\cdot$mol). H₂ 0, 0, 131
> • O₂ 0, 0, 205 • N₂ 0, 0, 192 •\
> C(gr) 0, 0, 6 • H₂O(l) $-286$, $-237$, 70 •\
> H₂O(g) $-242$, $-229$, 189 • CO₂ $-393.5$, $-394$, 214
> • CO $-110.5$, $-137$, 198 • CH₄ $-75$,
> $-51$, 186 • NH₃ $-46$, $-17$, 193 • NO 90,
> 87, 211 • NO₂ 34, 52, 240 • N₂O₄ 10, 98,
> 304 • HCl $-92$, $-95$, 187 • Cl₂ 0, 0,
> 223.
...
**4.** Calculate $\Delta H^\circ$ and then $\Delta G^\circ$ at
298 K for 2NO(g) + O₂(g) → 2NO₂(g) using
$\Delta G^\circ = \Delta H^\circ - T\Delta S^\circ$. Use your
$\Delta S^\circ$ from problem 3(a). 

*(working space)*

**5.** Now calculate $\Delta G^\circ$ for the same reaction the other
...
**8.** For 2CuO(s) → 2Cu(s) + O₂(g), $\Delta H^\circ = +312$ kJ
