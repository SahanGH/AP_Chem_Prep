...
Zumdahl §8.1–8.13 • PDF pp. 390–453 • 5 blocks
...
>
> A high-value chapter: nearly all of **CED Unit 2** lives here, and it
> also supplies two topics that belong to other units —
> **§8.4** (ions and ionic radii) is CED 1.8, and
> **§8.8** (bond energies) is CED 6.7, the bond-enthalpy topic Unit 6
...
> for most students is **lattice energy** (Block 2) and
> **computing $\Delta H$ from bond energies** (Block 3).
> 
> §8.6 (partial ionic character) is background reading only.

## Bond Types, Electronegativity, and Polarity Zumdahl §8.1–8.3

> 📌 **By the end you can…**
>
> - Classify bonds using electronegativity difference.
...
### The property that decides bond type `ZUM §8.2`
...
> 📌 **Note**
>
> These are regions on a *continuum*, not three separate boxes. Zumdahl
...
> 📘 **Worked example: ranking bond polarity**
>
> Order H-H, S-H, Cl-H, O-H, F-H by polarity.
> 
...
> this topic. CO₂ has two strongly polar C=O bonds and is
> **nonpolar**, because its linear geometry points them exactly opposite.
> Same story for BF₃ (trigonal planar) and CCl₄ (tetrahedral).

#### APPLICATION • Polarity decisions 20 min
...
> 📌 **By the end you can…**
>
> - Predict ion configurations and rank ionic radii, including
>    isoelectronic series.
> - Use Coulomb's law to rank lattice energies.

**Read:** Zumdahl §8.4–8.5 • PDF pp. 400–408
...
### How ions differ from their parent atoms `ZUM §8.4`
...
>
> Rank Se²⁻, Br-, Rb+, Sr²⁺ by decreasing size.
> 
...
### Coulomb's law, applied to a crystal `ZUM §8.5`
...
>
> Rank NaCl, MgO, and NaF by lattice energy magnitude.
> 
> Charge products: MgO is $(2)(2) = 4$; NaCl and NaF are both
> $(1)(1) = 1$. So MgO is far strongest.
> 
> Tiebreak NaF vs NaCl: F- is smaller than Cl-, so $r$ is
> shorter and the attraction stronger.
> 
> $$ \text{MgO} \gg \text{NaF} > \text{NaCl} $$
...
#### APPLICATION • Lattice energy reasoning 20 min
...
> 📌 **By the end you can…**
>
> - Relate bond order to bond length and bond energy.
> - Estimate $\Delta H$ for a reaction from bond energies.

**Read:** Zumdahl §8.7–8.8 • PDF pp. 409–415
...
### Breaking bonds always costs energy `ZUM §8.8`
...
> ⚠️ **AP trap**
>
> The order is **broken minus formed** — the reverse of the formation
...
> 📘 **Worked example 1: Zumdahl's HF synthesis**
>
> H₂(g) + F₂(g) → 2 HF(g)
> Bonds broken: one H-H (432) and one F-F (154).
> Bonds formed: two H-F (565 each).
> 
> $$ \Delta H = (432 + 154) - 2(565) = 586 - 1130 = -544\,\mathrm{kJ} $$
> 
> Compare with formation data: $2 \times (-271) = -542\,\mathrm{kJ}$.
> The two methods agree to within 2 kJ.

> 📘 **Worked example 2: HCl synthesis**
>
> H₂(g) + Cl₂(g) → 2 HCl(g)
> Broken: H-H 432 $+$ Cl-Cl 239 $= 671$.
> Formed: $2 \times \text{H-Cl}$ 427 $= 854$.
> 
> $$ \Delta H = 671 - 854 = -183\,\mathrm{kJ} $$
> 
> Formation data give $2(-92.3) = -184.6\,\mathrm{kJ}$ — again close.

> 📌 **Note**
>
> Bond energies give *estimates*, not exact values, because tabulated
...
#### APPLICATION • Full calculation 20 min

Bond energies (kJ/mol): N#N 941, H-H 432, N-H 391.

Compute $\Delta H$ for N₂(g) + 3 H₂(g) → 2 NH₃(g).
...
> 📌 **By the end you can…**
>
> - Draw Lewis structures reliably.
> - Recognize the three classes of octet exception.
...
Give the electron count, then the structure: PH₃, CO₂,
SO₂, ClO₄-.

*(working space)*

#### INSTRUCTION B • When the octet rule fails 20 min

### Three classes of exception `ZUM §8.11`
...
> ⚠️ **AP trap**
>
> Only period 3 and beyond can expand. Nitrogen *cannot* hold more than
> eight electrons, so structures like “NF₅” do not exist. If a
> structure needs an expanded octet on a period-2 atom, the structure is
> wrong.

#### APPLICATION • Diagnose the structures 20 min
...
> 📌 **By the end you can…**
>
> - Use formal charge to select the best structure.
> - Draw resonance sets and state their physical meaning.
> - Predict geometry and bond angles with VSEPR.

**Read:** Zumdahl §8.12–8.13 • PDF pp. 423–440
...
### Choosing among candidate structures `ZUM §8.12`
...
> 📘 **Worked example: nitrate**
>
> NO₃- has 24 electrons and three equivalent forms, with the double bond
> on each oxygen in turn.
> 
> The evidence that this is an average rather than an alternation: all three
> N–O bonds are measured to be *identical* in length, intermediate
...
### Geometry from electron-domain repulsion `ZUM §8.13`
...
#### APPLICATION • The full chain 20 min
