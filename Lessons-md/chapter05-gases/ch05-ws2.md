# Worksheet 2 • Gas Stoichiometry and Partial Pressures

*Chapter 5 • Gases*  
Zumdahl §5.4–5.5 • the molar-volume shortcut works ONLY at STP
...
> 📌 **Directions & data**
>
> Before using 22.42 L/mol, check that the problem
> says STP. If it gives any other temperature or pressure, use $PV = nRT$.

**1.** 2 KClO₃(s) → 2 KCl(s) + 3 O₂(g). $M(\text{KClO₃}) = 122.55$.

1. Volume of O₂ at STP from 24.51 g KClO₃:
   *(working space)*
2. Volume of that same O₂ at 25 °C and
   1.00 atm:
   *(working space)*
...
**3.** N₂(g) + 3 H₂(g) → 2 NH₃(g), all gases at the same
