# Worksheet 3 • KMT, Real Gases & FRQ

*Chapter 5 • Gases*  
Zumdahl §5.6–5.9 • name the failed postulate, not just ``it's real''
...
> 📌 **Directions & data**
>
> Deviation answers must name *which* postulate fails and
> *which direction* $PV/nRT$ moves. “Because it is a real gas” earns
> nothing.
...
A sample of 2.45 g KClO₃ ($M = 122.55\,\mathrm{g/mol}$)
is fully decomposed. The gas is collected at 25 °C with a total
pressure of 754 torr. The vapour pressure of water at
25 °C is 23.8 torr.
...
>
> **(a) 2 pts** 1 moles of KClO₃, 1 the 3:2 ratio applied
> • **(b) 2 pts** 1 subtraction performed, 1 conversion to atm
> • **(c) 2 pts** 1 correct rearrangement with kelvin, 1 value
> with units • **(d) 2 pts** 1 explains the mixture/Dalton
> reasoning, 1 states the direction of the error •\
> **(e) 2 pts** 1 predicts larger, 1 gives BOTH reasons — one reason
> only earns 1.
