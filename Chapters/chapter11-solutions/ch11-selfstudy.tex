...
\begin{apcnote}[AP scope: these units are read, not computed]
The CED's topic 3.8 exclusion: \emph{``Calculations of molality,
...
calculations to test \textbf{molarity} (Ladders 1--2) instead.
\end{apcnote}
...
those are \S11.4--11.7, which this course skips. The CED goes further
and names it directly: \emph{``calculations of molality \ldots\ will not
...
excludes mass-percent and molality \emph{calculations} from the exam
