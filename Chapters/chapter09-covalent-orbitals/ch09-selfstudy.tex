...
\begin{apcnote}[AP scope: the $d$-orbital labels are not assessed]
The CED's topic 2.7 exclusion is explicit: \emph{``Hybridization
...
know the \emph{shapes} --- trigonal bipyramidal and octahedral --- and
